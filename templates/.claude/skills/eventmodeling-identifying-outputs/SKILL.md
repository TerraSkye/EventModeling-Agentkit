...
Instead of writing a markdown document, **place each READMODEL on the board** using the `place-element` skill.

For each read model identified, invoke `place-element` with:
